...
describe('total likes', () => {
  ...
  test('when list has only one blog, equals the like of that', () => {
    ...
    expect(listHelper.totalLikes(oneItemBlogList)).toBe(oneItemBlogList[0].likes)
  })
...
describe('Favorite', () => {
  test('finds blog with highest likes', () => {
    const blogs = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
...
describe('Most blogs', () => {
  test('finds author with most blogs published', () => {
    const blogs = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
...
describe('Most likes', () => {
  test('finds author that has the most likes', () => {
    const blogs = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
